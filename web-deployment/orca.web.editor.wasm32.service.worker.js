...
/** @type {string} */
const CACHE_VERSION = '4.5.Orca Engine.custom_build';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["orca.editor.html", "offline.html", "orca.editor.js", "orca.editor.audio.worklet.js", "orca.editor.audio.position.worklet.js", "logo.svg", "favicon.png"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["orca.editor.wasm"];
